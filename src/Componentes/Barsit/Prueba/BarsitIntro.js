...
export default function BarsitIntro() {
  return (
    <div className="contenido">
      <div className="row">
        <div className="col-xl-1 md-3"></div>

        <div className="col-xl-10 md-9">
          ...
          <p>
            ...
            . Pasado ese tiempo, la prueba se cerrará automáticamente y se
            enviará los resultados obtenidos. Disponga de un lugar con una señal
            de internet constante, segura y libre de distracciones. Las
            preguntas serán similares a las que se presenta lineas abajo,
            aumentando la dificultad conforme avance.
          </p>
          <p>Ejemplos:</p>
          <div className="ejemplo">
            ...
            <div>
              <p className="pregunta">
                <b>3</b> De éstas 5 palabras, una pertenece a una clase
                diferente
              </p>
            ...
            <div>
              ...
              <p className="pregunta">
                <b>Rpta 4:</b> En este caso la respuesta es{" "}
                <b>&nbsp;Alimento</b>
              </p>
            </div>
            <div>
